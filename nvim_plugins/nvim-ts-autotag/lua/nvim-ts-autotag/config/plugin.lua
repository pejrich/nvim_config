...
local function setup_tag_configs()
    ...
    for _, i in ipairs({ "heex", "elixir" }) do
        TagConfigs:add(base_cfg:extend(i, {
            ...
            close_tag_pattern = { "end_tag", "end_component", "end_slot" },
            close_name_tag_pattern = { "tag_name", "component_name", "slot_name" },
        }))
    end
end
