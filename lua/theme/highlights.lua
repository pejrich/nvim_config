...
function M.init()
  ...
  vim.cmd("hi DiagnosticVirtualTextError guifg=" .. theme.syn.special3)
  vim.cmd("hi DiagnosticSignError guifg=" .. theme.syn.special3)
  -- vim.cmd("hi DiagnosticUnderlineError guibg=" .. "#0000FF")
  -- local linemode = require("lualine.utils.mode")
  -- -- Color table for highlights
  -- local palette = {
  --   bg = theme.ui.bg_dim,
  --   fg = theme.ui.fg_dim,
  --   black = theme.ui.bg_dim,
  ...
  --     DiagnosticHint({ fg = palette.fg }), -- Used as the base highlight group. Other Diagnostic highlights link to this by default (except Underline)
